[![Typing SVG](https://readme-typing-svg.demolab.com/?lines=Hello+👋!,+I'm+Shouvik+Dutta,+a+CS+undergrad+from+Kolkata,+India.;Driven+by+a+deep+passion+for+technology+and+its+endless+potential!;A+passionate+Software+Engineer+from+India.;&center=true&color=40b983&duration=7000&multiline=false&width=1000)](https://https://github.com/Shouvik-9)
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=c,cpp,java,python,html,css,js,react,mysql,aws,github,vscode,linux" />
  </a>
</p>
...
| To-Do List | [view](todolist-three-xi.vercel.app/) | [view](https://github.com/Shouvik-9/To-Do-List.git) | `HTML5` `CSS3` `JavaScript(Vanilla JS)` `Web Storage API (Local Storage)` | 
<br>
